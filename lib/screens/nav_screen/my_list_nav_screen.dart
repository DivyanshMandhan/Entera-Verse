...
class MyListNavScreen extends StatefulWidget {
  @override
  _MyListNavScreenState createState() => _MyListNavScreenState();
}

class _MyListNavScreenState extends State<MyListNavScreen> {
  final List<Widget> _screens = [
    MyListScreen(key: PageStorageKey('LatestScreen')),
    Scaffold(),
  ];
